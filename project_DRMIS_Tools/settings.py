"""
Django settings for project_DRMIS_Tools project.
...
# SECRET_KEY = '_irc$w0&kgsh$nj*m7xu$__1ed#-v+a&d5s#c1se6!nqap5-*_'
...
ROOT_URLCONF = 'project_DRMIS_Tools.urls'
...
WSGI_APPLICATION = 'project_DRMIS_Tools.wsgi.application'
